-- DISPOSABLE SYNTHETIC DATABASE ONLY. Minimal inventory authority for Incoming Stock receipt recovery tests.
do $$ begin
...
insert into public.stock(part_number,description,qty_on_hand) values('ABC123','Synthetic receipt stock',20);
