...
for (const knownRole of ["superuser", "engineer", "viewer"]) {
  if (!source.includes(`${knownRole}:`)) {
    throw new Error(`Auth guard regression: missing known role mapping: ${knownRole}`);
  }
}
