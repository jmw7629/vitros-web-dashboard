const TARGET_SHA = "59dcffb23cb275b6053e4de6ce243a16ffdc5f9e";
...
requireAll(ci, "CI", ['node scripts/secure-role-session-check.mjs', 'node scripts/rem-workbook-import-security-check.mjs', 'node scripts/vercel-convex-coupling-check.mjs']);
