const TARGET_SHA = "af110bea3985348b6094183ce77ce14bcea5b762";
...
for (const token of [
  'callerRole', 'callerUser', 'p_actor: args.', 'VITE_SUPABASE_SERVICE_ROLE_KEY',
  'from("stock").update', 'from("audit_log").insert', 'from("sap_staging").insert',
