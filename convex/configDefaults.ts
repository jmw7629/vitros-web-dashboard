...
export const TABLE_DEFAULTS = {
  stockSummaryColumns: [
    ...
    { key: "supportedModels", label: "Models", visible: true, order: 2 },
    { key: "module", label: "Subassembly", visible: true, order: 3 },
    { key: "subassemblyCodes", label: "Subcode", visible: true, order: 4 },
    { key: "systemSide", label: "Dry / Wet", visible: true, order: 5 },
    { key: "type", label: "Type", visible: true, order: 6 },
    { key: "qoh", label: "QOH", visible: true, order: 7 },
    { key: "minQty", label: "Min", visible: true, order: 8 },
    { key: "maxQty", label: "Max", visible: true, order: 9 },
    { key: "status", label: "Status", visible: true, order: 10 },
    { key: "onPlan", label: "On Plan", visible: true, order: 11 },
...
export const FORM_DEFAULTS = {
  partMasterFields: [
    ...
    { key: "module", label: "Subassembly", order: 7 },
    { key: "supportedModels", label: "Models", order: 8 },
    { key: "subassemblyCodes", label: "Subcode", order: 9 },
    { key: "systemSide", label: "Dry / Wet", order: 10 },
